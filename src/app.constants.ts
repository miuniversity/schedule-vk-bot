...
export const MESSAGES = {
  ru: {
    ...
    NOT_REGISTERED_FOR_SETTINGS:
      'Чтобы что-то менять, нужно сначала это что-то создать. Пройти регистрацию: начать',
    NO_ANSWER_RETRY:
    ...
    SETTINGS:
      ...
      '&#8226; Подробная неделя - показывать больше информации в расписании на неделю (напр. время, преподаватели)\n' +
